                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="../index.php?action=createBlogByAdmin" method="post" >
                                            ...
                                            <div class="form-floating mb-3 ">
                                                <textarea class="form-control" id="content" name="content" rows="30" style="height:100%;"><?= $content ?></textarea>
                                                <label for="content">Contenu</label>
                                            </div>

                                            <!-- Submition button-->
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><button class="btn btn-primary btn-block" id="submitButton" type="submit">Créer un blog</button></div>
                                            </div>
                                        </form>
                                        <br>
                                    </div>
